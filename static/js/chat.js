...
const date = new Date()
let h = conver(date.getHours())
let m = conver(date.getMinutes())
...
$(function () {
    ...
    function sendMessage() {
        ...
        const htmlData = `<div class="msg_item fn-clear">
            <div class="uface"><img src="../img/default.jpg" width="40" height="40"  alt=""/></div>
                <div class="item_right">
